...
parser$add_argument("--ntrain", type = "integer", default = 1, help = "training numbers,3000")
parser$add_argument("--ntest", type = "integer", default = 1, help = "testing numbers,10000")
